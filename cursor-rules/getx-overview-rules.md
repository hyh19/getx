...
**File:** `getx-dependency-management-rules.md`
...
**File:** `getx-state-management-rules.md`
...
**File:** `getx-route-management-rules.md`
...
**File:** `getx-internationalization-rules.md`
...
→ Use `getx-dependency-management-rules.md`

**Manage application state?**
→ Use `getx-state-management-rules.md`

**Navigate to a new screen or show a dialog?**
→ Use `getx-route-management-rules.md`

**Add multi-language support?**
→ Use `getx-internationalization-rules.md`

**Implement theme switching or dark mode?**
→ Use `getx-theme-rules.md`

**Need validation, responsive helpers, or utilities?**
→ Use `getx-utils-rules.md`
...
1. `getx-route-management-rules.md` - Define route and navigation
2. `getx-dependency-management-rules.md` - Create Binding for controller
3. `getx-state-management-rules.md` - Create controller with state
...
1. `getx-theme-rules.md` - Theme management
2. `getx-internationalization-rules.md` - Translation strings
...
1. `getx-utils-rules.md` - Validation and responsive helpers
2. `getx-state-management-rules.md` - Form state
...
|------|-----------|------------------|
| Inject dependency | `getx-dependency-management-rules.md` | `Get.put()`, `Get.lazyPut()` |
| Find dependency | `getx-dependency-management-rules.md` | `Get.find()` |
| Create reactive variable | `getx-state-management-rules.md` | `.obs` extension |
| Update UI reactively | `getx-state-management-rules.md` | `Obx()`, `GetX()` |
| Navigate to screen | `getx-route-management-rules.md` | `Get.to()`, `Get.toNamed()` |
| Show dialog | `getx-route-management-rules.md` | `Get.dialog()` |
| Show snackbar | `getx-route-management-rules.md` | `Get.snackbar()` |
| Translate text | `getx-internationalization-rules.md` | `.tr` extension |
| Change locale | `getx-internationalization-rules.md` | `Get.updateLocale()` |
| Change theme | `getx-theme-rules.md` | `Get.changeTheme()` |
| Check dark mode | `getx-theme-rules.md` | `Get.isDarkMode` |
| Validate email | `getx-utils-rules.md` | `GetUtils.isEmail()` |
| Responsive width | `getx-utils-rules.md` | `context.width` |
| Platform check | `getx-utils-rules.md` | `GetPlatform.isAndroid` |
